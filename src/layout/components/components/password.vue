<template>
  ...
  >
    <el-form :model="form" label-width="85px" :rules="rules" ref="form">
      ...
      <el-form-item label="新しいパスワード：" prop="newPassword">
        <el-input
          ...
          type="password"
          placeholder="6～20桁のパスワード、数字または英字、大文字と小文字を区別"
        ></el-input>
      </el-form-item>
      <el-form-item label="パスワードを確認：" prop="affirmPassword">
        <el-input
    ...
    <div slot="footer" class="dialog-footer">
      <el-button @click="handlePwdClose()">キャンセル</el-button>
...
export default class extends Vue {
  ...
  private validatePwd = (rule: any, value: any, callback: Function) => {
    ...
    if (!value) {
      ...
      callback(new Error('6～20桁のパスワード、数字または英字、大文字と小文字を区別'))
    } else {
      callback()
    }
  }
